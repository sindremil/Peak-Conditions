...
export default function LandingPage() {
  ...
  function getFirstDestinationPoint(destinationName: string): DestinationPoint {
    ...
    const destinationIndex = destinationsJson.destinations.findIndex(dest => dest.name === destinationName);
    
    // If the destination is found and has points, return the first point index
    if (destinationIndex !== -1 && destinationsJson.destinations[destinationIndex].points.length > 0) {
